...
**The footages for the bot conversation and config manager here in the github page is a bit outated. Check the modrinth page and  the mod to stay updated.** 
...
For playing the game,  the jar file either from modrinth or the  section and go directly to step 6.
...
Go to: https://bell-sw.com/pages//#jdk-21-lts

Click on  MSI and finish the installation process. [Windows]
...
https://www.jetbrains.com/idea//?section=windows
...
Or alternatively  it as a zip file, extract it and then open it in intellij
...
Step 5. Once done wait for intellij to build the project sources, this will take a while as it basically  minecraft to run in a test version.
...
**Below instructions are same irrespective of build from intellij or direct mod .**
